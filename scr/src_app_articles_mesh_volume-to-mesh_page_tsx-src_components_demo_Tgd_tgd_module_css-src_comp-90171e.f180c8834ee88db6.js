...
class VolumeToMeshManager {
    _context = null;
    midPointsPainter = null;
    cornersPainter = null;
    trianglesPainter = null;
    wireframePainter = null;
    set context(context) {
