...
function Settings(param) {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)("div", {
        className: _tolokoban_ui__rspack_import_2.Theme.classNames.join(className, _settings_module_css__rspack_import_4["default"].settings, show ? _settings_module_css__rspack_import_4["default"].show : _settings_module_css__rspack_import_4["default"].hide),
        children: [
