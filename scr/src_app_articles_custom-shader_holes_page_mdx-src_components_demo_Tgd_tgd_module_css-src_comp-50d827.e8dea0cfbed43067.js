...
class MaterialHole extends _tolokoban_tgd__rspack_import_1.TgdMaterial {
    options;
    lightDirection = new _tolokoban_tgd__rspack_import_1.TgdVec3(0.1, 0.2, 1);
    constructor(options) {
        super({
            uniforms: {
                texAbedo: "sampler2D",
