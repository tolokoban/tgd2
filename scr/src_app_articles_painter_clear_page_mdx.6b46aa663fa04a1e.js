"use strict";
(self["webpackChunk_tolokoban_tgd"] = self["webpackChunk_tolokoban_tgd"] || []).push([["src_app_articles_painter_clear_page_mdx"], {
...
32672(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _main_demo__rspack_import_4 = __webpack_require__(59718);
...
59718(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (Demo)
});
...
function init(canvas) {
    const ctx = new _tolokoban_tgd__rspack_import_1.TgdContext(canvas);
    const clear = new _tolokoban_tgd__rspack_import_1.TgdPainterClear(ctx, { color: [1, 0.7, 0, 1] });
    ctx.add(clear);
    let enabled = false;
    canvas.addEventListener("click", () => {
        const colorInterpolator = (0,_tolokoban_tgd__rspack_import_1.tgdActionCreateVec3Interpolation)({
            from: new _tolokoban_tgd__rspack_import_1.TgdVec3([clear.red, clear.green, clear.blue]),
            to: new _tolokoban_tgd__rspack_import_1.TgdVec3([Math.random(), Math.random(), Math.random()]),
            action: ([red, green, blue]) => {
                clear.red = red;
                clear.green = green;
                clear.blue = blue;
...
function Demo() {
    ...
    return ((0,react_jsx_runtime__rspack_import_0.jsx)("canvas", { ref: handleMount, style: {
            width: "320px",
            height: "240px",
            background: "#000",
        } }));
...
/* import */ var _main_demo__rspack_import_1 = __webpack_require__(32672);
