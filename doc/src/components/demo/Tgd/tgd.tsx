...
export default function Tgd<T extends SettingsDefinitions>({
	...
	React.useEffect(() => {
		...
		if (!canvas.requestFullscreen) {
			canvas.requestFullscreen = (canvas as unknown as Record<string, unknown>)[
				"webkitRequestFullscreen"
			] as (options?: FullscreenOptions) => Promise<void>
		}
	...
	if (noBorder) {
		return (
			...
			>
				...
				{settingValues && (
					<Settings<T> values={settingValues} onChange={setSettingValues} />
				)}
