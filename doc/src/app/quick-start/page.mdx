...
If you need more control, the `TgdContext` constructor accepts a second argument of type [TgdContextOptions](docs/classes/TgdContextOptions.html).
...
And to load the asset asynchronously, TGD provides the function [`tgdLoadGlb`]().
