...
import { type CommonProps, styleCommon, Theme, ViewButton, ViewPanel } from "@tolokoban/ui"
...
export function ViewAccessor(props: ViewAccessorProps) {
    ...
    return (
        <Expander className={$.join(props.className, Styles.accessor)} style={style} title={`Accessor #${index}`}>
