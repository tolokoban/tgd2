import { webglLookup, type TgdDataGlb, type TgdFormatGltfMeshPrimitiveAttribute } from "@tolokoban/tgd"
...
export function ViewAttribute({ className, data, attribute }: ViewAttributeProps) {
...
function renderValue(value: unknown, lookup = false) {
    if (value === undefined) return <em className={Styles.undefined}>undefined</em>
