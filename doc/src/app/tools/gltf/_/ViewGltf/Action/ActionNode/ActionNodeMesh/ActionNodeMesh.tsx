...
import { type CommonProps, Theme } from "@tolokoban/ui"
...
export function ViewActionNodeMesh({ className, data, meshIndexOrName: meshIndex }: ViewActionNodeMeshProps) {
                    ...
                    <li key={index}>
                        ...
                        {(primitive.material ?? -1) > -1 && (
                            <Expander
                                title={
                                    <div>
                                        Material <b>{data.getMaterial(primitive.material ?? -1)?.name ?? "Material"}</b>
                                    </div>
                                }>
