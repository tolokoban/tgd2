...
function init(context: TgdContext, assets: Assets) {
	...
	const textureColor0 = new TgdTexture2D(context).loadBitmap(
		tgdCanvasCreate(512, 512),
	);
	...
	constructor(context: TgdContext, texture: TgdTexture2D, rotationSpeed = 1) {
		...
		const state = new TgdPainterState(context, {
			...
			children: [
				cube,
				(time) => {
					cube.transfo.setEulerRotation(
						time * rotationSpeed * 71.54,
						time * rotationSpeed * 47.51,
						0,
					);
				},
			],
