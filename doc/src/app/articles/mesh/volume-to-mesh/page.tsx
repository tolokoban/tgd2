	...
	return (
		<div>
			...
			<p>
				...
				<br />A volume is a function that tells you, for each point in a box, it
				you are inside or outside an object.
			</p>
			<p>
				A voxel is a unit cube. Each corner of a voxel is either inside the
				volume (<b>red</b>) or outside (<b>blue</b>). With triangles, touching
				the edges of the voxel, we need to separate the space between red and
				blue corners.
			</p>
