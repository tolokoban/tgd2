...
import Layout88 from "./tricks/layout"
...
const Page66 = React.lazy(() => import("./articles/painter/x-ray/page.mdx"))
const Page67 = React.lazy(() => import("./articles/state/page.mdx"))
const Page68 = React.lazy(() => import("./articles/state/cull/page.mdx"))
const Page69 = React.lazy(() => import("./articles/state/stencil/page.mdx"))
const Page70 = React.lazy(() => import("./articles/suzanne/page.mdx"))
const Page71 = React.lazy(() => import("./articles/test/page.mdx"))
const Page72 = React.lazy(() => import("./articles/texture/page.mdx"))
const Page74 = React.lazy(() => import("./articles/texture/2d/bitmap/page.mdx"))
const Page75 = React.lazy(() => import("./articles/texture/2d/data/page.mdx"))
const Page76 = React.lazy(() => import("./articles/texture/cube/page.mdx"))
const Page77 = React.lazy(() => import("./articles/utils/page.mdx"))
const Page79 = React.lazy(() => import("./articles/utils/loaders/tgdLoadImageFromElement/page.mdx"))
const Page80 = React.lazy(() => import("./quick-start/page.mdx"))
const Page81 = React.lazy(() => import("./tools/page.mdx"))
const Page82 = React.lazy(() => import("./tools/filter/page"))
const Page83 = React.lazy(() => import("./tools/gltf/page"))
const Page84 = React.lazy(() => import("./tools/palette/page"))
const Page87 = React.lazy(() => import("./tools/palette/[value]/page"))
const Page88 = React.lazy(() => import("./tricks/page.mdx"))
const Page89 = React.lazy(() => import("./tricks/color-mask/page.mdx"))
const Page90 = React.lazy(() => import("./tricks/color-mask/2/page.mdx"))
const Page91 = React.lazy(() => import("./tricks/color-mask/3/page.mdx"))
        ...
        <Route path="/" Page={pg0} Layout={ly0} fallback={fb0} context={context}>
            ...
            <Route path="/articles" Page={pg2} Layout={ly2} fallback={fb0} context={context}>
                ...
                <Route path="/articles/painter" Page={pg33} Layout={ly33} fallback={fb0} context={context}>
                    ...
                    <Route path="/articles/painter/x-ray" Page={pg66} fallback={fb0} context={context}/>
                </Route>
                <Route path="/articles/state" Page={pg67} fallback={fb0} context={context}>
                    <Route path="/articles/state/cull" Page={pg68} fallback={fb0} context={context}/>
                    <Route path="/articles/state/stencil" Page={pg69} fallback={fb0} context={context}/>
                </Route>
                <Route path="/articles/suzanne" Page={pg70} fallback={fb0} context={context}/>
                <Route path="/articles/test" Page={pg71} fallback={fb0} context={context}/>
                <Route path="/articles/texture" Page={pg72} fallback={fb0} context={context}>
                    <Route path="/articles/texture/2d" fallback={fb0} context={context}>
                        <Route path="/articles/texture/2d/bitmap" Page={pg74} fallback={fb0} context={context}/>
                        <Route path="/articles/texture/2d/data" Page={pg75} fallback={fb0} context={context}/>
                    </Route>
                    <Route path="/articles/texture/cube" Page={pg76} fallback={fb0} context={context}/>
                </Route>
                <Route path="/articles/utils" Page={pg77} fallback={fb0} context={context}>
                    <Route path="/articles/utils/loaders" fallback={fb0} context={context}>
                        <Route path="/articles/utils/loaders/tgdLoadImageFromElement" Page={pg79} fallback={fb0} context={context}/>
                    </Route>
                </Route>
            </Route>
            <Route path="/quick-start" Page={pg80} fallback={fb0} context={context}/>
            <Route path="/tools" Page={pg81} fallback={fb0} context={context}>
                <Route path="/tools/filter" Page={pg82} fallback={fb0} context={context}/>
                <Route path="/tools/gltf" Page={pg83} fallback={fb0} context={context}/>
                <Route path="/tools/palette" Page={pg84} fallback={fb0} context={context}>
                    ...
                    <Route path="/tools/palette/[value]" Page={pg87} fallback={fb0} context={context}/>
                </Route>
            </Route>
            <Route path="/tricks" Page={pg88} Layout={ly88} fallback={fb0} context={context}>
                <Route path="/tricks/color-mask" Page={pg89} fallback={fb0} context={context}>
                    <Route path="/tricks/color-mask/2" Page={pg90} fallback={fb0} context={context}/>
                    <Route path="/tricks/color-mask/3" Page={pg91} fallback={fb0} context={context}/>
                </Route>
            </Route>
        </Route>
    )
