...
const Page6 = React.lazy(() => import("./articles/test/page.mdx"))
const Page7 = React.lazy(() => import("./articles/texture/page.mdx"))
const Page8 = React.lazy(() => import("./articles/texture/cube/page.mdx"))
const Page10 = React.lazy(() => import("./tools/gltf/page"))
    ...
    return (
        <Route path="/" Page={pg0} fallback={fb0}>
            <Route path="/articles" Layout={ly1} Template={tp1} fallback={fb0}>
                ...
                <Route path="/articles/test" Page={pg6} Template={tp1} fallback={fb0} />
                <Route path="/articles/texture" Page={pg7} Template={tp1} fallback={fb0}>
                    <Route path="/articles/texture/cube" Page={pg8} Template={tp1} fallback={fb0} />
                </Route>
            </Route>
            <Route path="/tools" fallback={fb0}>
                <Route path="/tools/gltf" Page={pg10} fallback={fb0} />
            </Route>
        </Route>
    )
}
