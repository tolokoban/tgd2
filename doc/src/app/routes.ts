...
export const ROUTES: Record<RoutePath, string[]> = {
    ...
    "/articles/mesh/geometry/shape": ["/articles/mesh/geometry/shape"],
    "/articles/mesh/geometry/shape/box": ["/articles/mesh/geometry/shape/box"],
    "/articles/mesh/geometry/shape/sphere-ico": ["/articles/mesh/geometry/shape/sphere-ico"],
    "/articles/mesh/geometry/tool": ["/articles/mesh/geometry/tool"],
    "/articles/mesh/geometry/tool/join": ["/articles/mesh/geometry/tool/join"],
    ...
    "/articles/mesh/material/flat-texture": ["/articles/mesh/material/flat-texture"],
    ...
    "/articles/mesh/material/mask": ["/articles/mesh/material/mask"],
    "/articles/mesh/material/mirror": ["/articles/mesh/material/mirror"],
    "/articles/mesh/material/normal-map": ["/articles/mesh/material/normal-map"],
    "/articles/mesh/material/solid": ["/articles/mesh/material/solid"],
    ...
    "/articles/painter/bbox": ["/articles/painter/bbox"],
    ...
    "/articles/painter/filter/bloom": ["/articles/painter/filter/bloom"],
    ...
    "/articles/painter/filter/several": ["/articles/painter/filter/several"],
    ...
    "/articles/painter/framebuffer/fixed-size": ["/articles/painter/framebuffer/fixed-size"],
    "/articles/painter/framebuffer/fixed-size/01": ["/articles/painter/framebuffer/fixed-size/01"],
    "/articles/painter/framebuffer/fixed-size/02": ["/articles/painter/framebuffer/fixed-size/02"],
    "/articles/painter/gizmo": ["/articles/painter/gizmo"],
    ...
    "/articles/painter/particles/example4": ["/articles/painter/particles/example4"],
    "/articles/painter/points-cloud": ["/articles/painter/points-cloud"],
    "/articles/painter/points-cloud/variant": ["/articles/painter/points-cloud/variant"],
    "/articles/painter/points-cloud/variant/default": ["/articles/painter/points-cloud/variant/default"],
    "/articles/painter/points-cloud/variant/material-flat": ["/articles/painter/points-cloud/variant/material-flat"],
    "/articles/painter/points-cloud/variant/material-sphere": ["/articles/painter/points-cloud/variant/material-sphere"],
    "/articles/painter/points-cloud/variant/morphing": ["/articles/painter/points-cloud/variant/morphing"],
    ...
    "/articles/painter/segments/morphing": ["/articles/painter/segments/morphing"],
    "/articles/painter/sprites": ["/articles/painter/sprites"],
    "/articles/painter/x-ray": ["/articles/painter/x-ray"],
    "/articles/state": ["/articles/state"],
    "/articles/state/blend": ["/articles/state/blend"],
    ...
    "/articles/texture/2d/fill": ["/articles/texture/2d/fill"],
