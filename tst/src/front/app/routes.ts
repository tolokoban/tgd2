...
export const ROUTES: Record<RoutePath, string[]> = {
    "/": ["/"],
    "/cases": ["/cases"],
    "/cases/painter": ["/cases/painter"],
    "/cases/painter/clear": ["/cases/painter/clear"],
    "/cases/painter/clear/red": ["/cases/painter/clear/red"],
    "/cases/painter/mesh": ["/cases/painter/mesh"],
    "/cases/painter/mesh/box": ["/cases/painter/mesh/box"],
    "/cases/painter/node": ["/cases/painter/node"],
}
