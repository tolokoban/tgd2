import { assertTgdTypeArrayForElements, TgdTypeArrayForElements } from "./elements"

export type TgdTypeArray = TgdTypeArrayForElements | Float32Array

export function assertTgdTypeArray(data: unknown): asserts data is TgdTypeArrayForElements {
