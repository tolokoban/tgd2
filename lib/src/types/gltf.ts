...
import type { ArrayNumber3, ArrayNumber4, ArrayNumber16 } from "./arrays"
            ...
            meshes: [
                "array",
                {
                    ...
                    primitives: [
                        "array",
                        {
                            attributes: ["map", typeAttribute],
                            indices: ["?", typeAttribute],
                            mode: ["?", "number"],
                            material: ["?", "number"],
                        },
                    ],
...
const typePbrMetallicRoughness: TypeDef = [
    "partial",
    {
        baseColorFactor: ["array", "number", { min: 4, max: 4 }],
