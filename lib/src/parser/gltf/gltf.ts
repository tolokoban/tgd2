...
export class TgdDataGlb {
    ...
    getImage(imageIndexOrName: number | string): TgdFormatGltfImage | undefined {
        ...
        if (typeof imageIndexOrName === "number") return images?.[imageIndexOrName]
    ...
    getMesh(meshIndexOrName: TgdFormatGltfMesh | number | string = 0): TgdFormatGltfMesh | undefined {
        if (typeof meshIndexOrName !== "number" && typeof meshIndexOrName !== "string") return meshIndexOrName
    ...
    getMeshOrThrow(meshIndexOrName: TgdFormatGltfMesh | number | string = 0): TgdFormatGltfMesh {
        if (typeof meshIndexOrName !== "number" && typeof meshIndexOrName !== "string") return meshIndexOrName
    ...
    getBufferViewData(
        ...
        type?: number | "Int8" | "Uint8" | "Int16" | "Uint16" | "Uint32" | "Float32",
    ): Int8Array | Uint8Array | Int16Array | Uint16Array | Uint32Array | Float32Array
    getBufferViewData(
        accessor: TgdFormatGltfAccessor | number,
        type: number | "Int8" | "Uint8" | "Int16" | "Uint16" | "Uint32" | "Float32" = "Float32",
    ): Int8Array | Uint8Array | Int16Array | Uint16Array | Uint32Array | Float32Array {
        ...
        if (!bufferView) throw new Error(`No bufferView with index #${bufferViewIndex}!`)
