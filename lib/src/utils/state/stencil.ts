...
} satisfies Record<string, WebglStencilOptions | ((value: number) => WebglStencilOptions)>

export function webglStencilSet(gl: WebGL2RenderingContext, stencil: WebglStencilOptions) {
    if (stencil.enabled) {
...
export function webglStencilGet(gl: WebGL2RenderingContext): WebglStencilOptions {
    ...
    return {
        ...
        functionFront: gl.getParameter(gl.STENCIL_FUNC) as WebglEnumStencilFunction,
        ...
        functionBack: gl.getParameter(gl.STENCIL_BACK_FUNC) as WebglEnumStencilFunction,
        ...
        operationFront1FailStencil: gl.getParameter(gl.STENCIL_FAIL) as WebglEnumStencilOperation,
        operationFront2FailDepth: gl.getParameter(gl.STENCIL_PASS_DEPTH_FAIL) as WebglEnumStencilOperation,
        operationFront3Pass: gl.getParameter(gl.STENCIL_PASS_DEPTH_PASS) as WebglEnumStencilOperation,
        operationBack1FailStencil: gl.getParameter(gl.STENCIL_BACK_FAIL) as WebglEnumStencilOperation,
        operationBack2FailDepth: gl.getParameter(gl.STENCIL_BACK_PASS_DEPTH_FAIL) as WebglEnumStencilOperation,
        operationBack3Pass: gl.getParameter(gl.STENCIL_BACK_PASS_DEPTH_PASS) as WebglEnumStencilOperation,
    }
}

export function webglStencilExec(gl: WebGL2RenderingContext, stencil: WebglStencilOptions, action: () => void) {
