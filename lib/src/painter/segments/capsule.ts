...
function makeTip(roundness: number, angleStepCylinder: number, offset: number[], tips: number[], elements: number[]) {
...
function makeCylinder(roundness: number, offset: number[], tips: number[], elements: number[]) {
