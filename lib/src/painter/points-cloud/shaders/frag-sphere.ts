...
export function fragCodeSphere(
    ...
    return [
        ...
        "if (z2 < 0.0) discard;",
        depthPrecision === "high" ? "z2 = sqrt(z2);" : "",
        depthPrecision !== "none" ? "gl_FragDepth = gl_FragCoord.z - z2 * varDepth;" : "",
        ...
        enableSpecular
            ...
            : "// No specular.",
        `return color * vec4(vec3(light * ${L}), 1.0) ${enableSpecular ? "+ vec4(vec3(spec), 0)" : ""
        };`,
    ]
}
