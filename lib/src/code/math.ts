 ...
 */
export function tgdCodeFunction_mapRange(options: Partial<{ name: string }> = {}): TgdCodeFunctions {
...
export function tgdCodeFunction_mod289(options: Partial<{ name: string }> = {}) {
...
export function tgdCodeFunction_permute(options: Partial<{ name: string }> = {}) {
 ...
 */
export function tgdCodeFunction_taylorInvSqrt(options: Partial<{ name: string }> = {}) {
 ...
 * Quintic function.
 */
export function tgdCodeFunction_quintic(options: Partial<{ name: string }> = {}) {
...
export function tgdCodeFunction_float01ToVec3(options: Partial<{ name: string }> = {}): TgdCodeFunctions {
...
export function tgdCodeFunction_vec3ToFloat01(options: Partial<{ name: string }> = {}): TgdCodeFunctions {
