import { ensureArray, TgdConsole, type WebglAttributeType, type WebglUniformType } from ".."
import {
    expandFunctions,
    expandVariables,
    type TgdCodeBloc,
...
export function expandOutputs<Type extends WebglAttributeType | WebglUniformType>(
